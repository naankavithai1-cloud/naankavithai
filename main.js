// =========================================================
// 9. main.js - CORE LOGIC (V3: PWA Registration Added)
// =========================================================
...
onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
        ...
        if (!logoutBtn || logoutBtn.classList.contains('hidden')) {
            // Ensure logout button is visible/created
        ...
        quickPostSection.classList.add('hidden'); // Hide post form when logged out
    }
});
...
document.getElementById('google-logout-btn').addEventListener('click', handleSignOut); // Ensure logout works
