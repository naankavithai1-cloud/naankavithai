// =========================================================
// 9. main.js - CORE LOGIC (V6: FINAL LOGIN FIX)
// =========================================================
...
async function signInWithGoogle() {
    ...
    try {
        ...
        // CRITICAL FIX: Reloading the page ensures the isAdmin flag is read correctly across all components
...
// =========================================================
// 7. EVENT LISTENERS & INITIALIZATION (CRITICAL FIX)
// =========================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // CRITICAL: Attach primary listeners ONLY when the DOM is ready
