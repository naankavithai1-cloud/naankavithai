// =========================================================
// 9. main.js - CORE LOGIC (V8: FINAL INDEX CONSISTENCY FIX)
// All critical logic is finalized to resolve persistent data loading errors.
// =========================================================
...
function setupRealtimeFeed() {
    const q = query(
        ...
        orderBy("createdAt", "asc"), // CRITICAL FIX: Changed to ASC to match the required index and fix the home feed loading error.
        limit(20) 
    );
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Attach primary listeners ONLY when the DOM is ready
